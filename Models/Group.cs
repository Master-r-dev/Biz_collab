...
namespace Biz_collab.Models
{
    public class Group
    {
        ...
        public int EntryFeeDon { get; set; } // минимальный внос для подключения в группу /Роль="Don" сила голоса=1      
        public int EntryFeeUser { get; set; } // минимальный внос для подключения в группу /Роль="User" сила голоса=1
        public int EntryFeeVIP { get; set; } // минимальный внос для подключения в группу /Роль="VIP" сила голоса=25% от кол-ва пользователей
        public int EntryFeeMod { get; set; } // минимальный внос для подключения в группу /Роль="Mod" сила голоса=50% от кол-ва пользователей
